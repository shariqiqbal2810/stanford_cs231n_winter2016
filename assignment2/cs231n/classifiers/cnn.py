...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    d_curr, grads['W3'], grads['b3'] = affine_backward(d_curr, cache3)
    d_curr, grads['W2'], grads['b2'] = affine_relu_backward(d_curr, cache2)
    d_curr, grads['W1'], grads['b1'] = conv_relu_pool_backward(d_curr, cache1)
